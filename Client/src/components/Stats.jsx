...
const Stats = () => {
  ...
  return (
    <div className="w-full flex flex-col justify-start items-center">
      <div className="w-full ps-10 pt-4 md:absolute md:top-6 md:left-6">
        <img
          src={logo}
          alt="Shortifi logo"
      ...
      <div className="p-4 md:px-10 lg:px-20 md:py-10 bg-[rgba(255,255,255,0.3)] rounded-lg flex justify-center items-center flex-col gap-8 text-white w-[80vw] text-base md:text-lg lg:text-xl font-medium mt-6">
        ...
        <div className="w-full flex flex-col gap-4 md:gap-6 md:flex-row ">
          <div className="flex flex-col w-full">
            <input
              type="text"
              id="longUrl"
              placeholder="https://urlshortner-wjpl.onrender.com/shortUrl"
