...
const Index = () => {
  ...
  return (
    <div className="p-4 md:px-10 lg:px-20 md:py-10 bg-[rgba(255,255,255,0.3)] rounded-lg flex justify-center items-center flex-col gap-8 text-white w-[80vw] mt-20 md:mt-0">
      <h1>URL Shortener</h1>
